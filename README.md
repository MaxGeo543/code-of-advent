...
The puzzle description will also be in a seperate textfile that automatically gets uupdated with part 2 once part 1 is completed.

Each python file has a part1() and part2() function that each return the result. 